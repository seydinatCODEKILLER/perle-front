...
import { ArrowLeft, Camera, User, Phone, Mail, IdCard, Shield, Calendar } from "lucide-react";
        ...
        {membership && (
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              />
              <Separator />
              <InfoRow icon={IdCard} label="ID de connexion" value={membership.loginId} />
              <Separator />
              <InfoRow icon={IdCard} label="Numéro de membre" value={membership.memberNumber || "Non attribué"} />
              <Separator />
              <InfoRow 
                icon={Calendar} 
                label="Date d'adhésion" 
                value={new Date(membership.joinDate).toLocaleDateString("fr-FR")} 
              />
              <Separator />
              <InfoRow 
                icon={Shield} 
                ...
                value={
                  <Badge variant={membership.status === "ACTIVE" ? "default" : "secondary"}>
                    {membership.status === "ACTIVE" ? "Actif" : membership.status}
                  </Badge>
                } 
              />
            </CardContent>
